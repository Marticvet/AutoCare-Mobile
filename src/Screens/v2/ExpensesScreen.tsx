...
const styles = StyleSheet.create({
    ...
    dateColumns: { flexDirection: "row", gap: spacing.md },
    dateColumn: { flex: 1 },
    summary: { backgroundColor: colors.ink, gap: spacing.md },
    summaryTop: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: spacing.lg },
    ...
    emissionsRow: { flexDirection: "row", alignItems: "baseline", justifyContent: "space-between", gap: spacing.md },
    ...
    trendMetric: { flex: 1, minWidth: 0, padding: spacing.sm, borderRadius: 12, backgroundColor: colors.canvas, gap: 3 },
    ...
    categoryName: { ...typography.body, color: colors.ink, textTransform: "capitalize" },
    categoryAmount: { ...typography.bodyStrong, color: colors.ink },
